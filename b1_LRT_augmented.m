...
%
% 3/2026 - Save the full operator L that is needed in the forward problem 
% to transform from the Radon domain to the time domain, as
% well as the index matrix that allows the forward calculation in one step.
% This version takes longer because all frequency components are
...
tic;
[ Rfft,f,L,m_index ] = Radon_conjgrad(P_axis,t,M,Delta,maxiter,rthresh,method);
...
if is_savemat
    ...
    mat.v_min = v_min;
    mat.v_max = v_max;
    save([LRTmatpath,'LRT_',method,'_aug.mat'],'mat');
end
